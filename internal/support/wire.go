...
func Wire(db *sql.DB, enc encryption.Service, authz application.AuthzRevoker) *transport.Handler {
	...
	service := application.NewService(repo, inviteRepo, userRoleRead, enc, authz)
